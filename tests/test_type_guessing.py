...
def test_type_guessing_1_from_num() -> None:
...
def test_type_guessing_3() -> None:
    ...
    not_corpus = [
        ...
        "Thirty it matter enable becomeDrawings offended yet answered jennings.",
    ]
...
def test_type_guessing_100() -> None:
...
def test_type_guessing_101() -> None:

    data = np.asarray(
        [["2022-02-02T12:13:14Z"], ["2022-02-25T15:16:17Z"], ["2022-05-02T18:19:20Z"]]
    )
    type_ = determine_column_types(data)[0]
    assert type_ == ColumnTypes.DATETIME_YMDHMS_ISO8601, (
