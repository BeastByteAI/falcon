...
class _BaseHistGradientBoosting(Model, ONNXConvertible, OptunaMixin):
    def __init__(
        self,
        estimator: Union[
            SklearnHistGradientBoostingClassifier, SklearnHistGradientBoostingRegressor
        ],
        **kwargs: Any,
    ):
    ...
    def get_search_space(cls, X: npt.NDArray, y: npt.NDArray) -> Union[Callable, Dict]:
        return {
            "max_iter": {"type": "int", "kwargs": {"low": 50, "high": 500}},
            "min_samples_leaf": {
                "type": "int",
                "kwargs": {"low": 5, "high": 20, "step": 5},
            },
            "learning_rate": {
                "type": "float",
                "kwargs": {"low": 0.001, "high": 1.0, "log": True},
            },
            "l2_regularization": {
                "type": "float",
                "kwargs": {"low": 1e-7, "high": 0.01, "log": True},
            },
        }
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        random_seed : int, optional
            by default 42
        """
        estimator = SklearnHistGradientBoostingRegressor(
            max_iter=max_iter,
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        random_seed : int, optional
            by default 42
        """
        estimator = SklearnHistGradientBoostingClassifier(
            max_iter=max_iter,
            learning_rate=learning_rate,
            l2_regularization=l2_regularization,
            min_samples_leaf=min_samples_leaf,
